...
<form action="{{ url('/agregarDocumentacion/'.$id) }}" method="post" enctype="multipart/form-data">
	<div class="w3-row">
...
<table class="w3-table-all">
	...
	for ($i=0; $i < count($documentacion); $i++) {
		...
		print_r('	<tr>
					...
					<td>
				      <img class="w3-bar-item w3-hide-small" style="width:85px" src='.asset("storage/img/".$multimedia->id).'>
				    </td>
				    <td>
						'.$descripcion.'
					</td>
