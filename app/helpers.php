...
class Helpers 
{
    ...
    {
        if ($rol == 'admin') {
            $acciones = "<td><a href='adminFormulario/".$idForm."'><img class='acciones' src='../resources/assets/img/administrationIcon.svg' style='width:30px;margin-left:5px;margin-right:15px;'></a><a id='eliminar'><img class='acciones' src='../resources/assets/img/deleteIcon.svg' width='30px'></a>
        ...
        if ($rol == 'user') {
            $acciones = "<td width='130px'><a href='editarFormulario/".$idForm."'><img src='../resources/assets/img/editIcon.svg' style='width:30px;margin-left:18px;margin-right:15px;'></a><a href='seguimiento/".$idForm."'><img src='../resources/assets/img/seguimientoIcon.svg' width='30px'></a>
            <div style='margin-top:4px;background-color:#f0e68c;border-radius:15px;' align='center'>
            <a href='generarPdf/".$idForm."' target='_blank' style='text-decoration:none;font-size:10px;color:black;'>GENERAR PDF</a></div>
